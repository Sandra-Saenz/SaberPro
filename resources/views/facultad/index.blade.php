  ...
  <div class="app-title">
    ...
    <ul class="app-breadcrumb breadcrumb side">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
              <h2 class="display-4 mb-0">FACULTADES</h2>
            <div class="tile-body">
                <p class="breadcrumb-item">Facultades que estan registradas para estudiar las pruebas saber PRO</p>
                <hr>
      ...
      <tbody>
          ...
          <tr>
            ...
            {{-- <button type="button" class="btn-edit" data-toggle="modal" data-target="#ventanaModal{{$faculty->id}}">Editar</button> --}}
              <a href="{{ route('facultad.edit', $faculty->id) }}" class="btn btn-sm btn-primary">Editar</a>
              <a href="{{ route('facultad.show', $faculty->id) }}" class="btn btn-sm btn-primary">Ver</a>
            </td>
          </tr>
          @endforeach
      </tbody>
