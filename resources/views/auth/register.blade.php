                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <input id="TD" type="text" class="form-control" name="TD" value="{{ old('TD') }}" required autocomplete="TD" autofocus>
                        </div>

                         <div class="form-group row">
                            <label for="ND" class="col-md-4 col-form-label text-md-right">{{ __('ND') }}</label>
                            <input id="ND" type="text" class="form-control" name="ND" value="{{ old('ND') }}" required autocomplete="ND" autofocus>
                        </div>
